    ...
    static inline AvenGl aven_gl_load(AvenGlLoadProcFn load) {
        ...
        gl.Uniform1i = (PFNGLUNIFORM1FPROC)load("glUniform1i");
        gl.Uniform1iv = (PFNGLUNIFORM1FVPROC)load("glUniform1iv");
        gl.Uniform2f = (PFNGLUNIFORM1FPROC)load("glUniform2f");
        gl.Uniform2fv = (PFNGLUNIFORM1FVPROC)load("glUniform2fv");
        gl.Uniform2i = (PFNGLUNIFORM1FPROC)load("glUniform2i");
        gl.Uniform2iv = (PFNGLUNIFORM1FVPROC)load("glUniform2iv");
        gl.Uniform3f = (PFNGLUNIFORM1FPROC)load("glUniform3f");
        gl.Uniform3fv = (PFNGLUNIFORM1FVPROC)load("glUniform3fv");
        gl.Uniform3i = (PFNGLUNIFORM1FPROC)load("glUniform3i");
        gl.Uniform3iv = (PFNGLUNIFORM1FVPROC)load("glUniform3iv");
        gl.Uniform4f = (PFNGLUNIFORM1FPROC)load("glUniform4f");
        gl.Uniform4fv = (PFNGLUNIFORM1FVPROC)load("glUniform4fv");
        gl.Uniform4i = (PFNGLUNIFORM1FPROC)load("glUniform4i");
        gl.Uniform4iv = (PFNGLUNIFORM1FVPROC)load("glUniform4iv");
        ...
        gl.VertexAttrib1fv = (PFNGLVERTEXATTRIB1FPROC)load("glVertexAttrib1fv");
        gl.VertexAttrib2f = (PFNGLVERTEXATTRIB1FPROC)load("glVertexAttrib2f");
        gl.VertexAttrib2fv = (PFNGLVERTEXATTRIB1FPROC)load("glVertexAttrib2fv");
        gl.VertexAttrib3f = (PFNGLVERTEXATTRIB1FPROC)load("glVertexAttrib3f");
        gl.VertexAttrib3fv = (PFNGLVERTEXATTRIB1FPROC)load("glVertexAttrib3fv");
        gl.VertexAttrib4f = (PFNGLVERTEXATTRIB1FPROC)load("glVertexAttrib4f");
        gl.VertexAttrib4fv = (PFNGLVERTEXATTRIB1FPROC)load("glVertexAttrib4fv");
