...
./build test --android --cc $ANDROID_CLANG \
    ...
    --stb-ccflags "--target=aarch64-linux-android22 $CFLAGS" \
    --android-ccflags "--target=aarch64-linux-android22 $CFLAGS"
cd android
...
./build test --android --cc $ANDROID_CLANG \
    ...
    --stb-ccflags "--target=armv7a-linux-androideabi22 $CFLAGS" \
    --android-ccflags "--target=armv7a-linux-androideabi22 $CFLAGS"
cd android
...
./build test --android --cc $ANDROID_CLANG \
    ...
    --stb-ccflags "--target=i686-linux-android22 $CFLAGS" \
    --android-ccflags "--target=i686-linux-android22 $CFLAGS"
cd android
...
./build test --android --cc $ANDROID_CLANG \
    ...
    --stb-ccflags "--target=x86_64-linux-android22 $CFLAGS" \
    --android-ccflags "--target=x86_64-linux-android22 $CFLAGS"
cd android
...
$ANDROID_APKSIGNER sign --key-pass pass:$KEY_PASS \
