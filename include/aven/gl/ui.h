    ...
    static inline void aven_gl_ui_mouse_move(AvenGlUi *ctx, Vec2 pos) {
    ...
    static inline void aven_gl_ui_push_thread(
        ...
        aff2_position(circle_trans, (Vec2){ 0.0f, 0.0f }, (Vec2){ 0.33f, 0.5f });
        aff2_compose(circle_trans, trans, circle_trans);
        aven_gl_shape_rounded_geometry_push_square(
            &ctx->shape.geometry,
            circle_trans,
    ...
    static inline void aven_gl_ui_push_plus(
        ...
        Aff2 plus_trans;
        aff2_position(plus_trans, (Vec2){ 0.0f, 0.0f }, (Vec2){ 0.25f, 0.75f });
        ...
        aff2_position(plus_trans, (Vec2){ 0.0f, 0.0f }, (Vec2){ 0.75f, 0.25f });
        aff2_compose(plus_trans, trans, plus_trans);
        aven_gl_shape_rounded_geometry_push_square(
            &ctx->shape.geometry,
            plus_trans,
    ...
    static inline void aven_gl_ui_push_minus(
        ...
        Aff2 shaft_trans;
        aff2_position(shaft_trans, (Vec2){ 0.0f, 0.0f }, (Vec2){ 0.66f, 0.25f });
    ...
    static inline void aven_gl_ui_push_zoomin(
        ...
        Aff2 plus_trans;
        aff2_position(plus_trans, (Vec2){ 0.15f, 0.15f }, (Vec2){ 0.5f, 0.5f });
        aff2_compose(plus_trans, trans, plus_trans);
    ...
    static inline void aven_gl_ui_push_circle(
        ...
        aff2_position(circle_trans, (Vec2){ 0.0f, 0.0f }, (Vec2){ 0.6f, 0.6f });
        aff2_compose(circle_trans, trans, circle_trans);
        aven_gl_shape_rounded_geometry_push_square(
            &ctx->shape.geometry,
            circle_trans,
    ...
    static inline void aven_gl_ui_push_circle_equals(
        ...
        Aff2 tree_trans;
        aff2_position(tree_trans, (Vec2){ 0.0f, 0.15f }, (Vec2){ 0.35f, 0.1f });
    ...
    static inline void aven_gl_ui_push_circle_tree(
        ...
        aff2_position(tree_trans, (Vec2){ 0.0f, 0.0f }, (Vec2){ 0.25f, 0.05f });
        aff2_compose(tree_trans, trans, tree_trans);
        aven_gl_shape_rounded_geometry_push_square(
            &ctx->shape.geometry,
            tree_trans,
    ...
    static inline void aven_gl_ui_push_right_arrow(
        ...
        Aff2 shaft_trans;
        aff2_position(shaft_trans, (Vec2){ -0.2f, 0.0f }, (Vec2){ 0.5f, 0.33f });
        aff2_compose(shaft_trans, trans, shaft_trans);
        aven_gl_shape_rounded_geometry_push_square(
            &ctx->shape.geometry,
            shaft_trans,
    ...
    static inline void aven_gl_ui_push_dice(
        ...
        Aff2 dice_trans;
        aff2_position(dice_trans, (Vec2){ 0.0f, 0.0f }, (Vec2){ 0.75f, 0.75f });
        ...
        aff2_position(dice_trans, (Vec2){ 0.0f, 0.0f }, (Vec2){ 0.6f, 0.6f });
        aff2_compose(dice_trans, trans, dice_trans);
        aven_gl_shape_rounded_geometry_push_square(
            &ctx->shape.geometry,
            dice_trans,
        ...
        aff2_position(dice_trans, (Vec2){ 0.0f, 0.0f }, (Vec2){ 0.15f, 0.15f });
        aff2_compose(dice_trans, trans, dice_trans);
        aven_gl_shape_rounded_geometry_push_square(
            &ctx->shape.geometry,
            dice_trans,
        ...
        aff2_position(dice_trans, (Vec2){ 0.3f, -0.3f }, (Vec2){ 0.15f, 0.15f });
        aff2_compose(dice_trans, trans, dice_trans);
        aven_gl_shape_rounded_geometry_push_square(
            &ctx->shape.geometry,
            dice_trans,
    ...
    static inline void aven_gl_ui_button_disabled(
        ...
        aven_gl_ui_push_button(ctx, trans, type, &ctx->disabled_colors);
    }
